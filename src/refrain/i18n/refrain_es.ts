...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>¿Restablecer todos los ajustes a sus valores predeterminados? Los tres Discord Application IDs (predeterminado + por fuente) no se tocan — todo lo demás (fuentes, privacidad, inicio automático, avanzado) vuelve a los valores predeterminados.
