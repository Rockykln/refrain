...
<context>
    ...
    <message>
        ...
        <translation>режим разработчика включён во время работы — время запуска не измерялось</translation>
    </message>
    <message>
...
The reset is saved right away, and changes you haven&apos;t saved yet are dropped.</source>
        <translation>Сбросить каждую настройку к значению по умолчанию? Все три Application ID Discord (по умолчанию + для источника), ваш подключённый аккаунт Last.fm и список «Недавно прослушанное» останутся нетронутыми — всё остальное (источники, конфиденциальность, автозапуск, дополнительно) вернётся к настройкам по умолчанию.
...
<context>
    ...
    <message>
        ...
        <translation>Оценка по месту трека до перезапуска Refrain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>{player} воспроизводит музыку, но не сообщает, какая это страница. Установите Plasma Browser Integration (пакет plasma-browser-integration и расширение браузера «Plasma Integration») или используйте Firefox.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Discord открыт, но вход не выполнен. Войдите в Discord, чтобы показывать статус.</translation>
    </message>
    <message>
...
Discard what you entered?</source>
        <translation>Вы ввели Application ID, но не применили его. После закрытия Refrain запустится без статуса Discord.
