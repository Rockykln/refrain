...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>Сбросить все настройки к значениям по умолчанию? Все три Discord Application ID (общий + для каждого источника) останутся нетронутыми — всё остальное (источники, приватность, автозапуск, дополнительно) вернётся к заводским значениям.
