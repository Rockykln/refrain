...
<context>
    ...
    <message>
        ...
        <translation>Измеряется только на этом компьютере и никуда не отправляется. Сохранено в {path}</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../ui/log_window.py" line="134"/>
        <source>Seen</source>
        <translation>Замечено</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>На чём работает Refrain и как он настроен — чтобы вставить в сообщение об ошибке</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Текст, который не помещается</translation>
    </message>
    <message>
        ...
        <translation>Работает уже {uptime} · Память: {rss} МБ · Потоки: {threads} · Открытые файлы: {files}</translation>
    </message>
    <message>
...
{error}</source>
        <translation>Не удалось записать {path}:
...
<context>
    ...
    <message>
        ...
        <translation>Покинуть Refrain?</translation>
    </message>
    <message>
        <location filename="../ui/external_link.py" line="18"/>
        <source>This opens a page in your browser:</source>
        <translation>В браузере откроется страница:</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Заскробблено в Last.fm</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Поиск по названию, исполнителю или альбому…</translation>
    </message>
    <message numerus="yes">
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%1 из %n трека</numerusform>
            <numerusform>%1 из %n треков</numerusform>
            <numerusform>%1 из %n треков</numerusform>
        </translation>
    </message>
    <message numerus="yes">
        ...
        <translation>
            <numerusform>Последний %n трек</numerusform>
            <numerusform>Последние %n трека</numerusform>
            <numerusform>Последние %n треков</numerusform>
        </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть в Apple Music</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Попробуйте другой запрос или источник.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Удалить все треки из истории?</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Название приложения: «{name}»</translation>
    </message>
    <message>
        <location filename="../ui/settings_window.py" line="127"/>
        <source>No such Discord application</source>
        <translation>Такого приложения Discord нет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Discord и Vencord/Vesktop — отдельные программы с отдельными подключениями, поэтому статус, отправленный в одну, не виден в другой. Когда эта опция включена, Refrain отправляет статус во все.</translation>
    </message>
    <message>
...
Everything stays on this computer and is never sent anywhere. Measuring costs a little performance. You can turn it off again under Advanced.</source>
        <translation>Refrain начнёт измерять собственное время отклика и то, как вы им пользуетесь: какие окна, вкладки и кнопки и как долго. Никогда — названия треков или то, что вы вводите.
...
Refrain will close. This cannot be undone.</source>
        <translation>Это безвозвратно удалит все данные Refrain и учётные данные Last.fm из связки ключей:

{listing}
  • Учётные данные Last.fm в связке ключей системы

Сама программа при этом НЕ удаляется — затем выполните:
...
Scrobbling works for this session, but you will have to connect Last.fm again after a restart.</source>
        <translation>Refrain не смог сохранить учётные данные Last.fm ни в связке ключей системы, ни в {path}.
...
The reset is saved right away, and changes you haven&apos;t saved yet are dropped.</source>
        <translation>Сбросить все настройки к значениям по умолчанию? Все три Application ID для Discord (основной + для источников) и подключённый аккаунт Last.fm останутся нетронутыми — всё остальное (источники, конфиденциальность, автозапуск, дополнительно) вернётся к заводским значениям.

Сброс сохраняется сразу же, а несохранённые изменения будут отменены.</translation>
    </message>
    <message>
...
{error}</source>
        <translation>Не удалось подключиться к Last.fm:
...
The settings you just changed will apply for this session but won&apos;t persist across a restart.</source>
        <translation>Refrain не смог выполнить запись в {path}:

{error}

Только что изменённые настройки действуют в текущем сеансе, но не сохранятся после перезапуска.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Включить Недавно прослушанное</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Включите трек в Apple Music в браузере или на телефоне по Bluetooth.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>На паузе · {source}</translation>
    </message>
    <message>
        <location filename="../ui/status_window.py" line="725"/>
        <source>Not set up yet</source>
        <translation>Ещё не настроено</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Приложение Discord не запущено</translation>
    </message>
    <message>
        <location filename="../ui/status_window.py" line="730"/>
        <source>Application ID rejected</source>
        <translation>Application ID отклонён</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключено, но скробблинг выключен</translation>
    </message>
    <message>
        <location filename="../ui/status_window.py" line="756"/>
        <source>Open Last.fm settings…</source>
        <translation>Открыть настройки Last.fm…</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n скробл ожидает отправки</numerusform>
            <numerusform>%n скробла ожидают отправки</numerusform>
            <numerusform>%n скроблов ожидают отправки</numerusform>
        </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>На паузе — публикация выключена</translation>
    </message>
    <message>
        <location filename="../ui/status_window.py" line="769"/>
        <source>Scrobbling as {user}</source>
        <translation>Скробблинг от имени {user}</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>В прошлый раз Refrain закрылся неожиданно.</translation>
    </message>
    <message>
        <location filename="../ui/status_window.py" line="780"/>
        <source>The report is in &lt;a href=&quot;crash&quot;&gt;{path}&lt;/a&gt;.</source>
        <translation>Отчёт находится в &lt;a href=&quot;crash&quot;&gt;{path}&lt;/a&gt;.</translation>
    </message>
    <message>
...
<context>
    ...
    <message numerus="yes">
        ...
        <translation>
            ...
            <numerusform>Last.fm: %n скробла ожидают</numerusform>
            <numerusform>Last.fm: %n скроблов ожидают</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Выполняется pipx…</translation>
    </message>
    <message>
        <location filename="../ui/update_dialog.py" line="176"/>
        <source>Running pip…</source>
        <translation>Выполняется pip…</translation>
    </message>
    <message>
...
Continue without Discord status?</source>
        <translation>Application ID не введён. Refrain запустится без статуса Discord (ID можно вставить позже в разделе «Настройки → Общие»).
...
<context>
    ...
    <message>
        ...
        <translation>пока ничего не измерено</translation>
    </message>
</context>
<context>
    <name>app</name>
...
On a desktop session this should normally be available automatically. Check that dbus-daemon is running and that DBUS_SESSION_BUS_ADDRESS is set in your environment.</source>
        <translation>Для работы Refrain нужна работающая шина сеанса D-Bus (она используется для блокировки единственного экземпляра, получения метаданных MPRIS из браузера и публикации медиауправления на панели Plasma).
...
• KDE Plasma / Cinnamon / LXQt / Budgie — should work out of the box; if not, your panel/bar may have crashed — try logging out and back in.</source>
        <translation>Системный трей недоступен. Refrain живёт в трее, поэтому ему нужен хост с поддержкой StatusNotifierItem. Обычные решения:

• GNOME — установите расширение «AppIndicator and KStatusNotifierItem Support» и перезапустите Refrain.
• MATE — установите «mate-applet-statusnotifier».
• XFCE — добавьте «xfce4-statusnotifier-plugin» на панель.
• Hyprland / Sway / i3 / river — используйте панель состояния с поддержкой StatusNotifierItem (модуль «tray» в waybar, polybar, i3status-rust «tray», …).
...
To remove the program itself, run:
  ...
  {cmd}</source>
        <translation>Все данные Refrain и учётные данные Last.fm в связке ключей удалены. Сейчас Refrain закроется.

Чтобы удалить саму программу, выполните:
