...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>Ripristinare tutte le impostazioni ai valori predefiniti? I tre Discord Application IDs (predefinito + per sorgente) restano invariati — tutto il resto (sorgenti, privacy, avvio automatico, avanzato) torna ai valori predefiniti.
