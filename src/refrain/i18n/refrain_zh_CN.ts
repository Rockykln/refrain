...
<context>
    ...
    <message>
        ...
        <translation>许可、商标与从属关系声明</translation>
    </message>
    <message>
...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>将所有设置恢复为默认值？三个 Discord 应用 ID（默认 + 每个来源）以及已连接的 Last.fm 账户保持不变——其余部分（来源、隐私、自启动、高级）都会恢复为出厂默认值。
...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation type="vanished">将所有设置重置为默认值? 三个 Discord Application ID (默认 + 每个来源) 保持不变 — 其他所有设置 (来源、隐私、自启动、高级) 将恢复为出厂默认值。
...
确认后请单击设置窗口底部的「应用」以保存重置。</translation>
    ...
    <message>
        <source>⬆  Update available — v{version}</source>
        <translation type="vanished">⬆  有可用更新 — v{version}</translation>
    </message>
</context><context>
