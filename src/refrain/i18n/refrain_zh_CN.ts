...
<context>
    ...
    <message>
        ...
        <translation>Discord 应用程序 Client ID</translation>
    </message>
    <message>
...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>将所有设置重置为默认值? 三个 Discord Application ID (默认 + 每个来源) 保持不变 — 其他所有设置 (来源、隐私、自启动、高级) 将恢复为出厂默认值。

确认后请单击设置窗口底部的「应用」以保存重置。</translation>
    </message>
</context>
<context>
    <name>TrayIcon</name>
