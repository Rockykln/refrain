...
<context>
    ...
    <message>
        ...
        <translation>Discord와 Vencord/Vesktop은 연결이 서로 다른 별개의 프로그램이므로, 한쪽에 보낸 상태는 다른 쪽에 표시되지 않습니다. 이 옵션을 켜면 Refrain이 모든 클라이언트에 상태를 게시합니다.</translation>
    </message>
    <message>
...
Everything stays on this computer and is never sent anywhere. Measuring costs a little performance. You can turn it off again under Advanced.</source>
        <translation>이제 Refrain은 자체 처리 시간과 사용 방식(어떤 창, 탭, 버튼을 얼마나 오래 사용했는지)을 측정합니다. 곡 제목이나 입력한 내용은 절대 측정하지 않습니다.
...
Refrain will close. This cannot be undone.</source>
        <translation>모든 Refrain 데이터와 키링의 Last.fm 인증 정보가 영구적으로 삭제됩니다:

{listing}
  • OS 키링의 Last.fm 인증 정보

프로그램 자체는 제거되지 않습니다 — 완료 후 다음 명령어를 실행하세요:
...
{error}</source>
        <translation>Last.fm에 연결할 수 없습니다:
...
The settings you just changed will apply for this session but won&apos;t persist across a restart.</source>
        <translation>Refrain이 {path}에 쓰지 못했습니다:
...
Scrobbling works for this session, but you will have to connect Last.fm again after a restart.</source>
        <translation>Refrain은 시스템 키링에도 {path}에도 Last.fm 인증 정보를 저장하지 못했습니다.

이번 세션에서는 스크로블이 작동하지만, 다시 시작한 후에는 Last.fm에 다시 연결해야 합니다.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;h2&gt;Refrain {version} 사용 가능&lt;/h2&gt;&lt;p&gt;현재 버전: &lt;b&gt;v{current}&lt;/b&gt;. 감지된 설치 유형: &lt;b&gt;{install_type}&lt;/b&gt;.&lt;/p&gt;</translation>
    </message>
    <message>
        <location filename="../ui/update_dialog.py" line="100"/>
        <source>&lt;b&gt;Release notes&lt;/b&gt;</source>
        <translation>&lt;b&gt;릴리스 노트&lt;/b&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>업데이트가 취소되었습니다.</translation>
    </message>
    <message>
...
Continue without Discord status?</source>
        <translation>Application ID를 입력하지 않았습니다. Refrain은 Discord 상태 없이 시작됩니다(ID는 나중에 설정 → 일반에서 붙여 넣을 수 있습니다).
...
<context>
    ...
    <message>
        ...
        <translation>아직 측정된 것 없음</translation>
    </message>
</context>
<context>
    <name>app</name>
...
On a desktop session this should normally be available automatically. Check that dbus-daemon is running and that DBUS_SESSION_BUS_ADDRESS is set in your environment.</source>
        <translation>Refrain을 실행하려면 정상적으로 동작하는 D-Bus 세션 버스가 필요합니다(단일 인스턴스 잠금, 브라우저에서 가져오는 MPRIS 메타데이터, Plasma 패널의 미디어 컨트롤 게시에 사용됩니다).
...
• KDE Plasma / Cinnamon / LXQt / Budgie — should work out of the box; if not, your panel/bar may have crashed — try logging out and back in.</source>
        <translation>사용할 수 있는 시스템 트레이가 없습니다. Refrain은 트레이에 상주하므로 StatusNotifierItem을 지원하는 호스트가 필요합니다. 일반적인 해결 방법:

• GNOME — &apos;AppIndicator and KStatusNotifierItem Support&apos; 확장 프로그램을 설치한 다음 Refrain을 다시 실행하세요.
• MATE — &apos;mate-applet-statusnotifier&apos;를 설치하세요.
• XFCE — 패널에 &apos;xfce4-statusnotifier-plugin&apos;을 추가하세요.
• Hyprland / Sway / i3 / river — StatusNotifierItem을 지원하는 상태 표시줄을 사용하세요(waybar의 &apos;tray&apos; 모듈, polybar, i3status-rust의 &apos;tray&apos; 등).
...
To remove the program itself, run:
  ...
  {cmd}</source>
        <translation>모든 Refrain 데이터와 키링의 Last.fm 인증 정보가 삭제되었습니다. Refrain이 곧 종료됩니다.

프로그램 자체를 제거하려면 다음을 실행하세요:
