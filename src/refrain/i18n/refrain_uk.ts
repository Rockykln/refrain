...
<context>
    ...
    <message>
        ...
        <translation>режим розробника увімкнено під час роботи — час запуску не вимірювався</translation>
    </message>
    <message>
...
The reset is saved right away, and changes you haven&apos;t saved yet are dropped.</source>
        <translation>Скинути кожне налаштування до типового значення? Усі три Application ID Discord (типовий + для джерела), ваш підключений акаунт Last.fm і список «Нещодавно прослухане» залишаться незмінними — усе інше (джерела, конфіденційність, автозапуск, додатково) повернеться до типових налаштувань.
...
Discard what you entered?</source>
        <translation>Ви ввели Application ID, але не застосували його. Після закриття Refrain запуститься без статусу Discord.
