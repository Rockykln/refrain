...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>Réinitialiser tous les paramètres à leurs valeurs par défaut ? Les trois Discord Application IDs (par défaut + par source) restent intacts — tout le reste (sources, confidentialité, démarrage auto., avancé) revient aux valeurs par défaut.
