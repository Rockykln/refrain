...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>すべての設定をデフォルトにリセットしますか? 3 つの Discord Application ID (デフォルト + ソースごと) はそのまま — その他 (ソース、プライバシー、自動起動、高度) は出荷時のデフォルトに戻ります。
...
<context>
    ...
    <message>
        ...
        <translation>⬆  アップデート利用可能 — v{version}</translation>
    </message>
    <message>
