...
<context>
    ...
    <message>
        ...
        <translation>実行中に開発者モードをオンにした — 起動時間は計測されていません</translation>
    </message>
    <message>
...
The reset is saved right away, and changes you haven&apos;t saved yet are dropped.</source>
        <translation>すべての設定をデフォルトにリセットしますか？ 3つの Discord Application ID（デフォルトとソースごと）、接続済みの Last.fm アカウント、「最近再生した曲」のリストはそのまま残ります — それ以外（ソース、プライバシー、自動起動、詳細設定）は出荷時のデフォルトに戻ります。
...
<context>
    ...
    <message>
        ...
        <translation>Discord: 未ログイン — ログインしてステータスを表示</translation>
    </message>
    <message>
