...
After confirming, click Apply at the bottom of the Settings window to save the reset.</source>
        <translation>Redefinir todas as configurações para o padrão? Os três Discord Application IDs (padrão + por fonte) permanecem intactos — todo o resto (fontes, privacidade, inicialização automática, avançado) volta ao padrão de fábrica.
